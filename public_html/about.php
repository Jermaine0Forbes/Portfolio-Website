            ...
            <div class="row justify-content-center">
                ...
                <div id="bio" class="row justify-content-center about-block">
                    ...
                    <div class=" col-10 col-sm-8 ">
                        ...
                        <!-- <div class="fluid">
                            <div class="col-6 contact-links flex">
                                <div class="col-sm-4 col-6 ">
                                    <p><a href="http://bit.ly/2diKuOb"> <i class="fa fa-linkedin" aria-hidden="true"></i></a></p>
                                </div>
                                <div class="col-sm-4 col-6 ">
                                    <p><a href="https://twitter.com/JFDzine"> <i class="fa fa-twitter" aria-hidden="true"></i> </a></p>
                                </div>
                                <div class="col-sm-4 col-6 ">
                                    <p><a href="tel:786-863-0270"><i class="fa fa-phone" aria-hidden="true"></i></a></p>
                                </div>
                                <div class="col-sm-4 col-6 ">
                                    <p><a href="mailto:jermaine0forbes@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i></a></p>
                                </div>
                            </div>
                        </div> -->
                    </div>
